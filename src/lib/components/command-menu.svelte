...
<Button
	...
	{...$$restProps}
>
	<span class="hidden lg:inline-flex"> Procurar sobre IA... </span>
	<span class="inline-flex lg:hidden">Procurar...</span>
	<kbd
...
<Command.Dialog bind:open>
	<Command.Input placeholder="Digite uma ferramenta ou pesquisa" />
	<Command.List>
